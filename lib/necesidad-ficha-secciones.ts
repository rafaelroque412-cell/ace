...
export const FICHA_SECCIONES: FichaSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { col: "forma_pago_area_conformidad", api: "formaPagoAreaConformidad", label: "Área que otorga la conformidad", subgrupo: "Forma de pago (Art. 67 de la Ley)", recomendado: true, baseLegal: "El pago exige el documento de conformidad suscrito por el servidor responsable del área que se designe aquí. Se compone solo con el «Área que otorga la conformidad» del Art. 144 y, si la contratación se imputa a una inversión, con el proyecto y su CUI; escribir aquí a mano deja de seguirlos.", ejemplo: "Sub Gerencia de Desarrollo Económico, del proyecto de inversión «186 MEJORAMIENTO Y AMPLIACION DE LOS SERVICIOS DE AGUA POTABLE…», con CUI 2661009" },
      ...
      { col: "conformidad_area", api: "conformidadArea", label: "Área que otorga la conformidad", subgrupo: "Otras condiciones del contrato", baseLegal: "Art. 144 Reglamento · el área usuaria es responsable de brindar la conformidad.", ejemplo: "Sub Gerencia de Desarrollo Económico" },
