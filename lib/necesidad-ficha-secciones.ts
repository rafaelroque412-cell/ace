...
export const FICHA_SECCIONES: FichaSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { col: "forma_pago_tipo", api: "formaPagoTipo", label: "Pago único o pagos a cuenta", subgrupo: "Forma de pago (Art. 67 de la Ley)", kind: "textarea", recomendado: true, baseLegal: "Art. 67 de la Ley · el requerimiento precisa si el pago es único o a cuenta y, en el segundo caso, su detalle.", ejemplo: "Un pago único contra conformidad de la totalidad de los bienes" },
      { col: "forma_pago_area_conformidad", api: "formaPagoAreaConformidad", label: "Área que otorga la conformidad", subgrupo: "Forma de pago (Art. 67 de la Ley)", recomendado: true, baseLegal: "El pago exige el documento de conformidad suscrito por el servidor responsable del área que se designe aquí.", ejemplo: "Sub Gerencia de Desarrollo Económico" },
