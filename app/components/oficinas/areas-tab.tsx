...
import type { Counter, Oficina } from "./use-oficinas";
...
export function AreasTab({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      >
        <p style={{ color: "var(--muted, #667)", fontSize: 13, margin: 0, maxWidth: 560 }}>
          Registra cada oficina/área emisora: nombre, entidad, RUC, responsable, siglas
          y estado. La numeración por tipo y la hoja membretada se configuran en las
          pestañas siguientes (solo después de tener el área creada).
        </p>
      ...
      {oficinas.length === 0 ? (
        <p style={{ color: "var(--muted, #667)", fontSize: 13 }}>
          ...
          o usa "Añadir oficina" para crear la primera.
        </p>
      ) : (
              ...
              >
                ...
                <label className="formField">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      patch(o.id, { responsable_nombre: e.target.value })
                    }
                ...
                <label className="formField">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      patch(o.id, { responsable_cargo: e.target.value })
                    }
    ...
    >
      ...
      >
        ...
        {state.kind === "loading-preview" ? (
          <p>
            <Loader2 size={14} className="expSpin" /> Analizando{" "}
        ...
        {state.kind === "importing" ? (
          <p>
            <Loader2 size={14} className="expSpin" /> Importando oficinas de{" "}
            <strong>{state.fileName}</strong>…
          </p>
        ) : null}
